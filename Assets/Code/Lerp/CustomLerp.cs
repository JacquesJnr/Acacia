/// <summary>
///  This is some Tweening code I wrote:
/// https://github.com/JacquesJnr/Custom-Lerp
///
/// This allows me to make some neat animations.
/// </summary>
...
public class CustomLerp : MonoBehaviour
{
    ...
    private void LerpRotation(GameObject g, Vector3 to, float time)
    {
        Vector3 z = Vector3.Lerp(g.transform.localEulerAngles, to, time);
        Vector3 lerpRotation = z;
    ...
    public void UI_Rotate(RectTransform rect, Vector3 to, float time, bool loop)
    {
        if (loop)
        {
            AddLooper(rect.gameObject, TweenType.rotate, rect.localEulerAngles, to, time);
        ...
        while(t < time)
        {
            switch (type)
            {
                ...
                case TweenType.scale:
                    ...
                    break;
                case TweenType.rotate:
                    LerpRotation(rect.gameObject, to, t / time);
                    break;
                default:
                    break;
            }
